...
public class PanelMorfologico extends JPanel {
	...
	public PanelMorfologico() {
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"1- Erosão", "2- Dilatação", "3- Abertura ", "4- Fechamento ", "5- Gradiente ", "6- Operacao Top Hat ", "7- Operacao Bottom Hat "}));
